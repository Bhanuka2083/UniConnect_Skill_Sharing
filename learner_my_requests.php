...
if (isset($_POST['submit_review'])) {
    ...
    $sql = "INSERT INTO reviews (course_id, learner_id, rating, comment) VALUES ($course_id, $learner_id, $rating, '$comment')";
...
$my_requests = mysqli_query($conn, "SELECT r.*, c.title, u.username as tutor_name, s.schedule_time, s.platform, s.meeting_details 
                                    ...
                                    LEFT JOIN sessions s ON r.request_id = s.request_id 
...
<body>
    ...
    <div style="padding: 20px; max-width: 800px; margin: auto; margin-top: 150px; height: auto;">
        <a href="learner_dashboard.php" style="text-decoration: none; color: rgba(4, 82, 24, 1);">← Back to Courses</a>
                ...
                <div class="status-box status-<?php echo $row['status']; ?>">
                    ...
                    <?php if($row['status'] == 'accepted'): ?>
                        <div class="session-info">
                            <h4 style="color: #5a7c7aff;">📅 Session Scheduled</h4>
                            <p><strong>Time:</strong> <?php echo date('F j, Y, g:i a', strtotime($row['schedule_time'])); ?></p>
                            <p><strong>Platform:</strong> <?php echo $row['platform']; ?></p>
                            <p><strong>Details:</strong> <?php echo $row['meeting_details']; ?></p>
                        </div>
                        ...
                        <div style="margin-top:20px; border-top:1px solid #ddd; padding-top:10px;">
                            ...
                            <form method="POST">
                                ...
                                <textarea name="comment" placeholder="How was the session?" required style="width: 100%; padding: 10px; border-radius: 5px; border: 1px solid #ccc; margin-top: 10px;"></textarea>
                                <button type="submit" name="submit_review" style="width: auto;">Submit Feedback</button>
                            </form>
                        </div>
                    ...
                    <?php else: ?>
                        <p style="color: #666; font-style: italic;">Waiting for tutor to respond...</p>
                    <?php endif; ?>
                </div>
            <?php endwhile; ?>
        <?php else: ?>
