...
if (isset($_POST['add_course'])) {
    ...
    $sql = "INSERT INTO courses (tutor_id, category_id, title, description) VALUES ('$tutor_id', '$cat_id', '$title', '$desc')";
...
<head>
    ...
    <title>Tutor Dashboard - UniConnect</title>
    <style>
        .nav-bar { 
            background: #2c3e50; 
            color: white; 
...
<body>
    ...
    <div class="header-containar">
        <nav id="mainNavbar">
            ...
            <div class="profession">
                ...
                <div>
                    <a href="tutor_requests.php" class="bell">
                        🔔 Requests <?php if($unread_count > 0) echo "<span class='badge'>$unread_count</span>"; ?>
                    </a>
                </div>
            </div>
    ...
    <!-- <div class="nav-bar">
        ...
        <div>
            ...
            <a href="logout.php" style="margin-left:20px; color:white;">Logout</a>
        </div>
    </div> -->
            ...
            <div class="card">
                ...
                <form method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" placeholder="e.g. Master React in 5 Days" required>
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" name="add_course">Post Course</button>
                </form>
            </div>
            ...
            <div class="card">
                ...
                <?php while($course = mysqli_fetch_assoc($my_courses)): ?>
                    <div class="course-card">
                        ...
                        <small>Category: <?php echo $course['category_name']; ?></small>
        ...
        if(mysqli_num_rows($reviews) > 0):
            while($rev = mysqli_fetch_assoc($reviews)): ?>
                <div style="border-bottom: 1px solid #eee; padding: 10px 0;">
                    ...
                    <strong><?php echo $rev['title']; ?></strong> - <em>by <?php echo $rev['username']; ?></em>
                    <p style="margin: 5px 0;"><?php echo $rev['comment']; ?></p>
                </div>
            <?php endwhile; 
        else: ?>
            <p>No reviews yet. Complete some sessions to get feedback!</p>
        <?php endif; ?>
    </div>
