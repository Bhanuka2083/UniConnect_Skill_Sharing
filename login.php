...
if (isset($_POST['login'])) {
    ...
    if ($user = mysqli_fetch_assoc($result)) {
        if (password_verify($password, $user['password'])) {
            ...
            elseif ($user['role'] == 'tutor') header("Location: tutor_dashboard.php");
    ...
    <style>
        ...
        * {
        ...
        body {
            width: 100%;
            /* min-height: 150vh; */
            /* background-image: url('assets/international-day-education-scene-with-fantasy-style.jpg'); */
...
<body>
    ...
    <div class="container">
        ...
        <form method="POST">
            ...
            <a href="register.php" class="link">New here? Create account</a>
        </form>
    </div>
